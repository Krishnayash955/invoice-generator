...
export default function InvoiceGenerator() {
  ...
  const onSubmit = async (data: InvoiceData) => {
    try {
      ...
      toast({
        title: 'Success!',
        description:
          'Your invoice PDF has been successfully created and downloaded.',
        duration: 5000,
      });
    } catch (error) {
      ...
      toast({
        title: 'Error',
        description:
          'There was a problem generating your invoice. Please try again.',
        variant: 'destructive',
        duration: 5000,
      });
    } finally {
  ...
  const handleSaveInvoice = async (data: InvoiceData) => {
    try {
      ...
      toast({
        title: 'Invoice Saved',
        description:
          'Your invoice has been successfully saved to the database.',
        duration: 5000,
      });
    } catch (error) {
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : 'There was a problem saving your invoice. Please try again.',
        variant: 'destructive',
        duration: 5000,
      });
    } finally {
  ...
  const sections = [
    ...
    },
    {
      ...
      color: accentColors.quaternary,
    },
    {
      id: 'notes',
      label: 'Additional Notes',
      icon: <Info className="h-5 w-5" />,
      color: accentColors.quinary,
    },
  ];
        ...
        <div className="flex flex-col items-center mb-8 md:mb-12">
          ...
          >
            <p className="text-gray-400 text-center max-w-2xl text-lg">
              Create professional invoices in seconds and deliver them to your
              clients with ease.
            </p>
          </motion.div>
        </div>
                          ...
                          <Card className="overflow-hidden border-0 shadow-sm bg-gray-800">
                            <div className="bg-gray-800 px-4 py-3 flex items-center justify-between border-b border-gray-700">
                              <div className="flex items-center">
                                <Badge
                                  variant="outline"
                                  className="mr-2 bg-gray-900 border-gray-700 text-gray-300"
                                >
                                  #{index + 1}
                                </Badge>
